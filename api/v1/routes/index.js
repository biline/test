...
var blogposts = [
    {lang:'ru',link:'#projects', title: 'Центральный Банк РА - Поставка новых лицензий ORACLE и техподдержки', images: [/*'assets/img/blog/photo (9).jpg', 'assets/img/blog/photo (10).jpg'*/], date: new Date()},
    {lang:'ru',link:'#projects',title: 'Армениан Кард ЗАО  - Обновление и модернизация: Поставка и инсталляция HP Blade Severs и поставка, инсталляция, запуск и техническое обслуживание систем хранения данных (СХД) HP 3PAR для основного и резервного датацентров банка, включая коммуникационное оборудование для СХД, источники бесперебойного питания и их устройства для распределения питания.', images: [/*'assets/img/blog/photo (8).jpg', 'assets/img/blog/photo (11).jpg'*/], date: new Date()},

    {lang:'en',link:'#projects', title: 'Central Bank of Armenia - Supply of New Oracle licenses and technical support', images: [/*'assets/img/blog/photo (9).jpg', 'assets/img/blog/photo (10).jpg'*/], date: new Date()},
    {lang:'en',link:'#projects',title: 'Armenian Card (ArCA) CJSC  - Supply, Installation, upgrade and technical support of HP Blade Servers and HP 3 PAR storage solution for main and backup Data Centers, including network and uninterruptable power supply equipment', images: [/*'assets/img/blog/photo (8).jpg', 'assets/img/blog/photo (11).jpg'*/], date: new Date()},

    {lang:'hy',link:'#projects', title: 'ՀՀ Կենտրոնական Բանկ - ORACLE նոր ծրագրային ապահովման արտոնագրորի մատակարարում և տեխնիկական աջակցություն', images: [/*'assets/img/blog/photo (9).jpg', 'assets/img/blog/photo (10).jpg'*/], date: new Date()},
    {lang:'hy',link:'#projects',title: 'Արմենիան քարդ ՓԲԸ  - HP Blade Server-ների և HP 3PAR տվյալների պահպանման համակարգերի մատակարարում, տեղադրում, գործարկում և տեխնիկական սպասարկում բանկի առաջնային և պահեստային կայքերի համար, ներառյալ նշված համակարգերի կոմունիկացիոն սարքավորումները, անխափան սնման աղբյուրներրը և նրանց բաշխիչ սարքերը.', images: [/*'assets/img/blog/photo (8).jpg', 'assets/img/blog/photo (11).jpg'*/], date: new Date()},
